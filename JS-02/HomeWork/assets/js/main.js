...
function task5() {
    ...
    //let tree = Math.floor(num % 1000 / 100);
    let four = Math.floor(num % 10000 / 1000);
    let five = Math.floor(num / 10000);
...
function task6() {
    ...
    let action = document.getElementById('inputGroupSelect01').value;
    num = parseInt(num);
    let EUR = 33.1441;
    let UAH = 28.1610;
    let AZN = 16.5672;
...
function task8() {
    ...
    let rez = '';
    let circleDiameter = num1 / Math.PI;
    let squareSide = num2 / 4;
...
function task9() {
    debugger;
    let num1 = document.getElementById('question_1').value,
...
function task10() {
    ...
    document.getElementById('result_10').innerText = (`${resDay} ${resMonth} ${resYear}`);
}