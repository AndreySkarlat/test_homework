...
$(document).ready(function () {
  ...
  var btnContainer = document.getElementById("nav__list"); // Get all buttons with class="btn" inside the container

  var btns = btnContainer.getElementsByClassName("nav__link"); // Loop through the buttons and add the active class to the current/clicked button
