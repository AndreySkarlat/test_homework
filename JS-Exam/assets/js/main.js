$(document).ready(function() {
    ...
    $(".news-title").text(function(i, text) {
        if (text.length >= 40) {
            ...
            let Index = text.indexOf("."); // позиция точки
            if (Index != -1) {
...
let greenIcon = L.icon({
    ...
    shadowSize: [106, 106], // size of the shadow
...
function initMap() {
    ...
    let monticello = L.layerGroup();

    L.marker([40.68358442550612, -73.90182292110401], { icon: greenIcon }).bindPopup('Monticello.').addTo(monticello);
