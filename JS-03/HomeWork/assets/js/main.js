...
function task4() {
    let num = document.getElementById("num_4").value;
    num = parseInt(num);
    let res = 0;
    while (num > 0) {
...
function task5() {
    ...
    document.getElementById("res_5").innerHTML = (`Pos: ${pos}, Neg: ${neg}, Zero: ${zero}, Even: ${even}, Odd: ${odd}.`);
}
...
function task7() {
    ...
    num = parseInt(num);
    let step = document.getElementById("num_7_2").value;
    step = parseInt(step);
    let i = 0,
        side_a = num,
        side_b = num,
