...
function task2() {
    let num = document.getElementById("num_2").value,
        result = '';
    result = factorial(num);
    document.getElementById("res_2").innerHTML = `${num}! = ${result}`;
}
...
//2 var
function task4() {
    let w = document.getElementById("num_4_1").value,
...
function task6() {
    let num1 = document.getElementById("num_6_1").value,
...
function task8() {
    let num1 = document.getElementById("num_8_1").value,
